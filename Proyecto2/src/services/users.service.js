...
let APImarvel= 'https://gateway.marvel.com/v1/public/&ts=1&limit=100&apikey=d6a6422e8d251d428b8f90d5111c1a9e&hash=6b4f0cb5ba7847cf83a2631c7cbcaddd';
...
//const limit = 100;
    ...
    APImarvel = `https://gateway.marvel.com/v1/public/characters?nameStartsWith=${charname}&limit=100&ts=1&apikey=d6a6422e8d251d428b8f90d5111c1a9e&hash=6b4f0cb5ba7847cf83a2631c7cbcaddd`;
...
export const marvel2 = async(charname)=>{
  try {
//const limit = 100;

    APImarvel = `https://gateway.marvel.com/v1/public/characters?nameStartsWith=cap&limit=20&ts=1&apikey=d6a6422e8d251d428b8f90d5111c1a9e&hash=6b4f0cb5ba7847cf83a2631c7cbcaddd`;
    const response = await fetch(APImarvel);
...
export const updateusername = async(username, username2) =>{

  
  const response = await fetch(`${externalApiUrl}updateun`, {
      method: 'POST',
      headers: {
          'Content-Type': 'application/json',
      },
...
export const updateuseremail = async(username, useremail) =>{

  
  const response = await fetch(`${externalApiUrl}updateue`, {
      method: 'POST',
      headers: {
          'Content-Type': 'application/json',
      },
...
export const updateuserquestion = async(username, userquestion) =>{

  const response = await fetch(`${externalApiUrl}updateuq`, {
      method: 'POST',
      headers: {
          'Content-Type': 'application/json',
      },
      body: JSON.stringify({ username, userquestion}),
  });
...
export const updateuseranswer = async(username, useranswer) =>{

  let hash = createHash("md5").update(useranswer).digest("hex");
  const response = await fetch(`${externalApiUrl}updateua`, {
      method: 'POST',
      headers: {
          'Content-Type': 'application/json',
      },
...
export const updateuserposition = async(username, userposition) =>{

  const response = await fetch(`${externalApiUrl}updateup`, {
      method: 'POST',
      headers: {
          'Content-Type': 'application/json',
      },
      body: JSON.stringify({ username, userposition}),
  });
...
// servicio.js
export const cerrar = (res) => {
  res.clearCookie('token', { path: '/', domain: 'localhost' });
  
};

export const cerrar2 = async (username, carrito) =>{
  ...
  const response = await fetch(`${externalApiUrl}carrito2`, {
    method: 'POST',
    headers: {
        'Content-Type': 'application/json',
    },
