 ...
 * @author lalqu
 */
public class Bodegar extends javax.swing.JPanel {

    /**
     * Creates new form Bodegar
     */
    public Bodegar() {
        initComponents();
        tblBodega.setEnabled(false);
    }
    ...
    public void mostrarTblBode()
    {
        ConsultaSimp mltb = new ConsultaSimp();
        
        DefaultTableModel modelo = mltb.Bodega();
